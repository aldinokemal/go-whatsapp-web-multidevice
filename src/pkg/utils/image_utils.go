...
// compressToJPEGWithDepth converts an image to JPEG format with specified quality
// and tries to compress it to stay under the file size limit, with recursion depth tracking
